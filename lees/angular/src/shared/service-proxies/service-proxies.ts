...
export class StudentsServiceProxy {
     ...
     * @return Success
     */
    getAllStudentList(name: string | undefined): Observable<StudentDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Students/GetAllStudentList?";
        if (name === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllStudentList(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllStudentList(<any>response_);
                } catch (e) {
    ...
    protected processGetAllStudentList(response: HttpResponseBase): Observable<StudentDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    get(id: number | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "/api/services/app/Students/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getAll(maxResultCount: number | undefined, skipCount: number | undefined): Observable<StudentDtoPagedResultDto> {
    ...
    create(body: StudentDto | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "/api/services/app/Students/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    update(body: StudentDto | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "/api/services/app/Students/Update";
        url_ = url_.replace(/[?&]$/, "");
